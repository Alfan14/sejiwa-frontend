                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Assessment</span>
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="ms-3">Rekomendasi</span>
                                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                href="/home/find-conselor"
                                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            >
                                ...
                                <span className="ms-4">Cari Konselor</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                href="/home/booking-schedule"
                                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            >
                                ...
                                <span className="ms-4">Booking Jadwal</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="ms-4">Profile Saya</span>
                            </Link>
                        </li>
                        <li>
                            <Link
